...
function TradeTypeDefinition() {
  return {
    ...
    fields: {
      tradeId: { location: { bitOffset: 0, byteOffset: 0, mask: 0 }, type: int64TypeDefinition },
      tradeName: {
...
function LocalDateTypeDefinition() {
  return {
    ...
    fields: {
      year: { location: { bitOffset: 0, byteOffset: 0, mask: 0 }, type: int16TypeDefinition },
      month: { location: { bitOffset: 16, byteOffset: 2, mask: 0 }, type: int8TypeDefinition },
      day: { location: { bitOffset: 24, byteOffset: 3, mask: 0 }, type: int8TypeDefinition }
    },
...
function stringTypeDefinition() {
  return {
    ...
    count: { encodingType: 'Int32' as const, location: { bitOffset: 0, byteOffset: 0, mask: 0 } },
...
function RfqUpdateTypeDefinition() {
  return {
    ...
    cases: {
      ...
      quoteAccepted: {
        tag: 3,
        payload: { location: { bitOffset: 8, byteOffset: 1, mask: 0 }, type: QuoteIdTypeDefinition }
      },
      rfqClosed: {
        tag: 4,
        payload: {
...
function RfqClosedTypeDefinition() {
  return {
    ...
    encodedLength: { bitLength: 40, byteLength: 5 },
    fields: {
      id: { location: { bitOffset: 0, byteOffset: 0, mask: 0 }, type: RfqIdTypeDefinition },
      state: { location: { bitOffset: 32, byteOffset: 4, mask: 0 }, type: RfqStateTypeDefinition }
    },
    jsonConverter: undefined
  }
}
...
function QuoteBodyTypeDefinition() {
  return {
    ...
    fields: {
      id: { location: { bitOffset: 0, byteOffset: 0, mask: 0 }, type: QuoteIdTypeDefinition },
      rfqId: { location: { bitOffset: 32, byteOffset: 4, mask: 0 }, type: RfqIdTypeDefinition },
      dealerId: {
        location: { bitOffset: 64, byteOffset: 8, mask: 0 },
        type: DealerIdTypeDefinition
      },
      price: { location: { bitOffset: 96, byteOffset: 12, mask: 0 }, type: PriceTypeDefinition },
      state: {
...
function DealerIdListTypeDefinition() {
  return {
    type: 'list' as const,
    count: { encodingType: 'Int16' as const, location: { bitOffset: 0, byteOffset: 0, mask: 0 } },
...
function AcceptQuoteResponseTypeDefinition() {
  return {
    type: 'union' as const,
    cases: { ack: { tag: 1, payload: undefined }, nack: { tag: 2, payload: undefined } },
...
function AcceptQuoteRequestTypeDefinition() {
  return {
    ...
    encodedLength: { bitLength: 32, byteLength: 4 },
    fields: {
      quoteId: { location: { bitOffset: 0, byteOffset: 0, mask: 0 }, type: QuoteIdTypeDefinition }
    },
    jsonConverter: undefined
  }
}
...
function CreateQuoteRequestTypeDefinition() {
  return {
    ...
    fields: {
      rfqId: { location: { bitOffset: 0, byteOffset: 0, mask: 0 }, type: RfqIdTypeDefinition },
      dealerId: {
        location: { bitOffset: 32, byteOffset: 4, mask: 0 },
        type: DealerIdTypeDefinition
      },
      price: { location: { bitOffset: 64, byteOffset: 8, mask: 0 }, type: PriceTypeDefinition }
    },
    jsonConverter: undefined
  }
}
...
function CreateRfqResponseTypeDefinition() {
  return {
    ...
    cases: {
      ack: {
        tag: 1,
        payload: { location: { bitOffset: 8, byteOffset: 1, mask: 0 }, type: RfqIdTypeDefinition }
      },
      nack: { tag: 2, payload: undefined }
    },
    encodedLength: { bitLength: 40, byteLength: 5 }
...
function DealerBodyTypeDefinition() {
  return {
    ...
    fields: {
      id: { location: { bitOffset: 0, byteOffset: 0, mask: 0 }, type: DealerIdTypeDefinition },
      name: { location: { bitOffset: 32, byteOffset: 4, mask: 0 }, type: stringRefTypeDefinition }
    },
    jsonConverter: undefined
  }
}
...
function InstrumentBodyTypeDefinition() {
  return {
    ...
    fields: {
      id: { location: { bitOffset: 0, byteOffset: 0, mask: 0 }, type: InstrumentIdTypeDefinition },
      name: { location: { bitOffset: 32, byteOffset: 4, mask: 0 }, type: stringRefTypeDefinition },
      cusip: { location: { bitOffset: 64, byteOffset: 8, mask: 0 }, type: stringRefTypeDefinition },
      ticker: {
        location: { bitOffset: 96, byteOffset: 12, mask: 0 },
        type: stringRefTypeDefinition
      },
...
function EchoResponseTypeDefinition() {
  return {
    ...
    encodedLength: { bitLength: 32, byteLength: 4 },
    fields: {
      payload: { location: { bitOffset: 0, byteOffset: 0, mask: 0 }, type: int32TypeDefinition }
    },
    jsonConverter: undefined
  }
}
...
function CurrencyPairUpdatesTypeDefinition() {
  return {
    ...
    fields: {
      ...
      isStale: { location: { bitOffset: 33, byteOffset: 4, mask: 2 }, type: boolTypeDefinition }
    },
    jsonConverter: undefined
  }
}
...
function CurrencyPairTypeDefinition() {
  return {
    ...
    fields: {
      symbol: { location: { bitOffset: 0, byteOffset: 0, mask: 0 }, type: SymbolRefTypeDefinition },
      ratePrecision: {
        location: { bitOffset: 32, byteOffset: 4, mask: 0 },
        type: int32TypeDefinition
      },
...
function PriceTickTypeDefinition() {
  return {
    ...
    fields: {
      symbol: { location: { bitOffset: 0, byteOffset: 0, mask: 0 }, type: SymbolRefTypeDefinition },
      bid: { location: { bitOffset: 32, byteOffset: 4, mask: 0 }, type: PriceTypeDefinition },
      ask: { location: { bitOffset: 96, byteOffset: 12, mask: 0 }, type: PriceTypeDefinition },
      mid: { location: { bitOffset: 160, byteOffset: 20, mask: 0 }, type: PriceTypeDefinition },
      valueDate: {
        location: { bitOffset: 224, byteOffset: 28, mask: 0 },
        type: LocalDateTypeDefinition
      },
...
function ExecutionResponseTypeDefinition() {
  return {
    ...
    encodedLength: { bitLength: 32, byteLength: 4 },
    fields: {
      trade: { location: { bitOffset: 0, byteOffset: 0, mask: 0 }, type: TradeRefTypeDefinition }
    },
    jsonConverter: undefined
  }
}
...
function ExecuteTradeRequestTypeDefinition() {
  return {
    ...
    fields: {
      ...
      spotRate: { location: { bitOffset: 32, byteOffset: 4, mask: 0 }, type: PriceTypeDefinition },
      valueDate: {
        location: { bitOffset: 96, byteOffset: 12, mask: 0 },
        type: LocalDateTypeDefinition
      },
...
function HistoricPositionTypeDefinition() {
  return {
    ...
    fields: {
      ...
      usdPnl: { location: { bitOffset: 32, byteOffset: 4, mask: 0 }, type: float64TypeDefinition }
    },
    jsonConverter: undefined
  }
}
...
function CurrencyPairPositionTypeDefinition() {
  return {
    ...
    fields: {
      symbol: { location: { bitOffset: 0, byteOffset: 0, mask: 0 }, type: SymbolRefTypeDefinition },
      basePnl: { location: { bitOffset: 32, byteOffset: 4, mask: 0 }, type: float64TypeDefinition },
      baseTradedAmount: {
        location: { bitOffset: 96, byteOffset: 12, mask: 0 },
        type: float64TypeDefinition
      },

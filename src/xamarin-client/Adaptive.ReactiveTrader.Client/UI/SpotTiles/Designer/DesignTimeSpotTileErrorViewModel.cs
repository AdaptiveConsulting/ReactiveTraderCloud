...
namespace Adaptive.ReactiveTrader.Client.UI.SpotTiles.Designer
{
    ...
    {
        public string ErrorMessage => "An error occurred while executing the trade. Please check your blotter and if your position is unknown, contact your support representative.";

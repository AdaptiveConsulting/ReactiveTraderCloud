...
export const ListItem: React.FC<Props> = ({ title, active, hover, disabled }) => {
  return (
...
const Root = styled.div<{ active?: boolean; hover?: boolean; disabled?: boolean }>`
  padding: 8px 8px 5px 8px;
  background-color: ${({ theme, active, hover }) =>
    active ? theme.core.activeColor : hover ? theme.primary.base : theme.core.dividerColor};
  width: 115px;
  border-radius: 3px;

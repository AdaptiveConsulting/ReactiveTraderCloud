...
export const ConnectionActions = {
  connect: action<CONNECTION_ACTION_TYPES.CONNECT_SERVICES>(
    CONNECTION_ACTION_TYPES.CONNECT_SERVICES
  ),
  disconnect: action<CONNECTION_ACTION_TYPES.DISCONNECT_SERVICES>(
    CONNECTION_ACTION_TYPES.DISCONNECT_SERVICES
  ),
}

export type ConnectionAction = ActionUnion<typeof ConnectionActions>

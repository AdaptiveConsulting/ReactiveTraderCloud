...
import {
  ...
  Tenth,
  ExpiredPrice,
} from "@/widgets/spotTile/components/PriceButton/styled"
...
const TradeButton = styled.button<{
  ...
  background-color: ${({ theme, direction }) =>
    direction === Direction.Sell ? "#f94c4c" : "#5f94f5"};
  border-radius: 3px;
  color: #fff;
...
const PriceButtonComp: React.FC<PriceButtonProps> = ({
  ...
  return (
    ...
    >
      ...
      {expired && (
        <ExpiredPrice data-qa="price-button__expired">Expired</ExpiredPrice>
      )}
    </TradeButton>
  )
}

...
const getCurrentPositions = ({ analyticsService }: GlobalState) =>
  analyticsService && analyticsService.currentPositions
const selectPositionsChartModel = createSelector(
  [getCurrentPositions],
  (currentPositions) => getPositionsChartModel(currentPositions),
)

const getHistory = ({ analyticsService }: GlobalState) =>
  analyticsService && analyticsService.history
const selectAnalyticsLineChartModel = createSelector([getHistory], (history) =>
  getModel(history),
)

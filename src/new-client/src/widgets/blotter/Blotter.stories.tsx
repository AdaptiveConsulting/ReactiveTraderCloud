...
const blotterRejectedRow: Trade = {
  ...
  symbol: "GBPJPY",
  tradeDate: new Date(
    "Thu Jul 26 2018 13:29:30 GMT-0400 (Eastern Daylight Time)",
  ),
  tradeId: 2340,
  traderName: "CZA",
  valueDate: new Date(
    "Sun Jul 29 2018 20:00:00 GMT-0400 (Eastern Daylight Time)",
  ),
}
...
const blotterSuccessRow: Trade = {
  ...
  symbol: "EURJPY",
  tradeDate: new Date(
    "Thu Jul 26 2018 14:46:12 GMT-0400 (Eastern Daylight Time)",
  ),
  tradeId: 2356,
  traderName: "DOR",
  valueDate: new Date(

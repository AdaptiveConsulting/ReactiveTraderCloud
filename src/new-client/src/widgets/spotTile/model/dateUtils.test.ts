...
describe("spotDateFormatter", () => {
  ...
  it("should return the formatted date according to different time zone", () => {
    ...
    const formattedAnchorageDate = spotDateFormatter(
      spotDate,
      true,
      zoneNames.anchorage,
    )
    ...
    const formattedSydneyDate = spotDateFormatter(
      spotDate,
      true,
      zoneNames.sydney,
    )
    ...
    const formattedEasterIslandDate = spotDateFormatter(
      spotDate,
      true,
      zoneNames.easterIsland,
    )
    expect(formattedEasterIslandDate).toEqual("SP. 29 JAN")

    const formattedDubaiDate = spotDateFormatter(
      spotDate,
      true,
      zoneNames.dubai,
    )
  ...
  it("should return the formatted dat in utc if localZoneName is undefined", () => {
    const formatteUndefinedZoneDate = spotDateFormatter(
      spotDate,
      true,
      undefined,
    )

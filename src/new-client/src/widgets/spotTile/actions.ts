...
export const SpotTileActions = {
  ...
  rfqRequest: action<TILE_ACTION_TYPES.RFQ_REQUEST, RfqRequest>(
    TILE_ACTION_TYPES.RFQ_REQUEST,
  ),

  rfqReceived: action<TILE_ACTION_TYPES.RFQ_RECEIVED, RfqReceived>(
    TILE_ACTION_TYPES.RFQ_RECEIVED,
  ),

  rfqExpired: action<TILE_ACTION_TYPES.RFQ_EXPIRED, RfqExpired>(
    TILE_ACTION_TYPES.RFQ_EXPIRED,
  ),

  rfqRequote: action<TILE_ACTION_TYPES.RFQ_REQUOTE, RfqRequest>(
    TILE_ACTION_TYPES.RFQ_REQUOTE,
  ),

  rfqReject: action<TILE_ACTION_TYPES.RFQ_REJECT, RfqReject>(
    TILE_ACTION_TYPES.RFQ_REJECT,
  ),

  rfqCancel: action<TILE_ACTION_TYPES.RFQ_CANCEL, RfqCancel>(
    TILE_ACTION_TYPES.RFQ_CANCEL,
  ),

  rfqReset: action<TILE_ACTION_TYPES.RFQ_RESET, RfqReset>(
  ...
  unsubscribeToSpotTile: action<
    TILE_ACTION_TYPES.SPOT_TILE_UNSUBSCRIBE,
    string
  >(TILE_ACTION_TYPES.SPOT_TILE_UNSUBSCRIBE),
  priceUpdateAction: action<
    TILE_ACTION_TYPES.SPOT_PRICES_UPDATE,
    SpotPriceTick
  >(TILE_ACTION_TYPES.SPOT_PRICES_UPDATE),
  priceHistoryReceived: action<

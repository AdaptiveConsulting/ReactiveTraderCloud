...
export const FloatingTools: React.FunctionComponent<Props> = ({ themeName, switchTheme }) => {
...
const Root: React.FunctionComponent = props => <Block backgroundColor="primary.2" {...props} />

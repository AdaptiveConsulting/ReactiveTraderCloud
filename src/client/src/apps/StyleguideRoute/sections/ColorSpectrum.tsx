...
export const ColorSpecturm: React.FC = () => (
  <React.Fragment>
    <SectionBlock py={0} pt={2} mh={0}>
      ...
      <Paragraph>
        The following shows the full color spectrum availble to be used within the application.
        Changing a base color will show the variants available. These colors are used to populate
        the basic style guide of the application.
      </Paragraph>
    </SectionBlock>

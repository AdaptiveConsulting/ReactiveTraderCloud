...
export const RFQ_CREATED_RFQ_UPDATE = "rfqCreated",
  QUOTE_UPDATED_RFQ_UPDATE = "quoteUpdated",
...
export type QuoteUpdatedRfqUpdate = {
  type: typeof QUOTE_UPDATED_RFQ_UPDATE
  payload: QuoteBody
}
...
function RfqUpdateTypeDefinition() {
  return {
    ...
    cases: {
      ...
      startOfStateOfTheWorld: { tag: 6, payload: undefined },
      endOfStateOfTheWorld: { tag: 7, payload: undefined },
    },
...
function DealerBodyTypeDefinition() {
  return {
    ...
    fields: {
      ...
      name: {
        location: { bitOffset: 32, byteOffset: 4, mask: 0 },
        type: stringRef_134TypeDefinition,
      },
    },
    jsonConverter: undefined,
  }
...
function PriceStreamRequestTypeDefinition() {
  return {
    ...
    fields: {
      symbol: {
        location: { bitOffset: 0, byteOffset: 0, mask: 0 },
        type: SymbolRef_106TypeDefinition,
      },
    },
    jsonConverter: undefined,
  }
    ...
    return HydraPlatform.requestResponse$(
      {
        ...
        serviceVersion: "rrAcxKgYARPNU2jtWRFD0RqQrl4=",
        majorVersionContentAddress:
          "0x1969632c0052ad4abf74024a67fd8190b6b071d6",
        methodName: "quote",
        inboundStream: "one",
        outboundStream: "empty",
        routingData: {
    ...
    return HydraPlatform.requestResponse$(
      {
        ...
        serviceVersion: "rrAcxKgYARPNU2jtWRFD0RqQrl4=",
        majorVersionContentAddress:
          "0x59ea93f09b5746dd807c6323678dc340092c0e51",
        methodName: "pass",
        inboundStream: "one",
        outboundStream: "empty",
        routingData: {
    ...
    return HydraPlatform.requestResponse$(
      {
        ...
        serviceVersion: "rrAcxKgYARPNU2jtWRFD0RqQrl4=",
        majorVersionContentAddress:
          "0x4738ffa663326638c943d0ea2f4a9a1cf88ee6a5",
        methodName: "accept",
        inboundStream: "one",
        outboundStream: "empty",
        routingData: {
    ...
    return HydraPlatform.requestStream$(
      {
        ...
        serviceVersion: "rrAcxKgYARPNU2jtWRFD0RqQrl4=",
        majorVersionContentAddress:
          "0xd4792958fcd7b757a40728e81dcc532cd2bc369b",
        methodName: "subscribe",
        inboundStream: "empty",
        outboundStream: "many",
        routingData: {

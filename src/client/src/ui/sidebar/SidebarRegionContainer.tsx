...
type SidebarRegionContainerProps = SidebarRegionContainerStateProps &
  SidebarRegionContainerDispatchProps

class SidebarRegionContainer extends React.Component<

...
export const StatusIndicator: React.SFC<StatusIndicatorProps> = (
  ...
  const wrapperClasses = classnames(
    'status-indicator footer__status-indicator',
    wrapperStatusCssLookup[props.status]
  )
  const iconClasses = classnames(
    'status-indicator__icon',
    iconStatusCssLookup[props.status]
  )

...
export default class FxPage extends BasePage {
  readonly spotTileComponent
  readonly blotterComponent
  readonly analyticsComponent

  constructor(public readonly page: Page) {
    super(page)

    this.spotTileComponent = new SpotTileComponent(this.page)
    this.blotterComponent = new BlotterComponent(this.page)
    this.analyticsComponent = new AnalyticsComponent(this.page)
  }
